	...
	var methods = {
		...
		init: function (options) {
			...
			return this.each(function () {
				var trigger = this,
					$trigger = $(this),
					$confirmYes = $('<button class="' + params.fastConfirmClass + '_proceed"><span>' + params.proceedText + '</span></button>'),
					$confirmNo = $('<button class="' + params.fastConfirmClass + '_cancel"><span>' + params.cancelText + '</span></button>'),
